...
class NewExtractor(FeatureExtractor):
    ...
    def getFeatures(self, state, action):
        ...
        # count the number of ghosts 1-step away that are not scared / almost not scared
        features["#-of-ghosts-1-step-away"] = sum((next_x, next_y) in Actions.getLegalNeighbors(g.getPosition(), walls) for g in ghostStates if g.scaredTimer < 2)
